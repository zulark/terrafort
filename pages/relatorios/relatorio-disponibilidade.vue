    ...
    <div class="min-h-screen">
        <div class="container mx-auto py-8 px-2 content-center">
            ...
            <ReportTable
                ...
                :search-keys="['nome','categoria_maquina.nome_categoria','status']"
            ...
            >
                ...
                <template #cell-situacao="{ item }">
                  <span v-if="item.status === 'Disponível'" class="bg-green-100 text-green-800 px-2 py-1 rounded">Disponível</span>
                  <span v-else-if="item.status === 'Alugada'" class="bg-red-100 text-yellow-800 px-2 py-1 rounded">Indisponível</span>
                  <span v-else-if="item.status === 'Em manutenção'" class="bg-red-100 text-red-800 px-2 py-1 rounded">Indisponível</span>
